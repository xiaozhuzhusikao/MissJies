...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        mBgColor = typeArray.getColor(R.styleable.ParticleView_pv_background_color, 0xFFFFFFFF);
        mParticleColor = typeArray.getColor(R.styleable.ParticleView_pv_text_color, 0xFFFFFFFF);
